"""
Count number of articles in which keywords appear
...
from defoe.papers.query_utils import clean_article_as_string, get_articles_list_matches, preprocess_clean_article
